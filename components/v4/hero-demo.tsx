...
// Demo conversacional do hero da /v4 (fundo branco): mesma lógica da v3,
// paleta clara. Simula a experiência do player sem gravar resposta.
...
export function HeroDemo() {
  ...
  return (
    <div className="relative">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-xl shadow-slate-300/40 overflow-hidden">
        ...
        <div className="p-6 sm:p-8 min-h-[340px] flex flex-col justify-center">
          <AnimatePresence mode="wait">
            {step === 0 && (
              ...
              >
                <p className="text-sm text-amber-700 font-semibold mb-2">1 de 3</p>
                ...
                <input
                  ...
                  className="w-full bg-transparent border-b-2 border-slate-300 focus:border-[#F5B731] outline-none text-lg text-slate-900 placeholder:text-slate-400 py-2 transition-colors"
                />
                <div className="mt-5 flex items-center gap-3">
                  ...
                  <span className="text-xs text-slate-500 hidden sm:block">
                    ou pressione <strong className="text-slate-600">Enter ↵</strong>
                  </span>
                </div>
              </motion.div>
            )}
            ...
            {step === 1 && (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <p className="text-sm text-amber-700 font-semibold mb-2">2 de 3</p>
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-5">
                  ...
                  {GOALS.map((g, i) => (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 text-left px-4 py-3 rounded-xl border text-sm sm:text-base transition-all ${
                        goal === g
                          ? 'border-[#F5B731] bg-[#F5B731]/10 text-slate-900'
                          : 'border-slate-200 bg-slate-50 text-slate-700 hover:border-[#F5B731]/60 hover:bg-amber-50'
                      }`}
                    >
                      <span className="w-6 h-6 rounded-md border border-slate-300 bg-slate-100 text-xs font-bold flex items-center justify-center text-slate-500">
            ...
            {step === 2 && (
              <motion.div
                ...
                transition={{ duration: 0.3 }}
              >
                <p className="text-sm text-amber-700 font-semibold mb-2">3 de 3</p>
                <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-5">
