...
/**
 * Hero da /v4 — a demonstração que TAMBÉM captura (D-10, 20/08/2026).
 *
 ...
 *
 * O protocolo mora em `use-hero-capture` (compartilhado com a /v3). Aqui só o visual claro.
 */
export function HeroDemo() {
  ...
  const passoWrap = (chave: string, indice: number, titulo: string, conteudo: React.ReactNode) => (
    ...
    >
      ...
      <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-5">{titulo}</h3>
      {conteudo}
    </motion.div>
  )
  ...
  return (
    <div className="relative">
      ...
      <div className="rounded-2xl border border-white/10 bg-white shadow-xl shadow-slate-300/40 overflow-hidden">
            ...
            {h.passo === 4 && passoWrap('q5', 5, 'Quantas respostas por mês você espera?', (
              <>
                ...
                <div className="mt-5">
                  ...
                  {h.erro && (
                    <p role="alert" className="mt-3 flex items-start gap-2 text-xs text-red-600">
